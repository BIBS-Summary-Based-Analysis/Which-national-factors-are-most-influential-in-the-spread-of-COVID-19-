...
#### Study Period Setting( ~ 12/14) ####
max_date <- set_date("2020/12/14") 

#### Importing Data #### 
# Importing daily confirmed cases data
# df <- read.csv("C:/Users/김학용/Desktop/코로나 연구 인턴/주차별 작업사항/최종 정리(날짜 수정,11.30)/data/COVID-19-geographic-disbtribution-worldwide-2020-12-14.csv")
